...
public class BasicTrajectorySimulation : MonoBehaviour
{
    ...
    void simulatePath()
    {
        ...
        Vector3 segVelocity = transform.right * (SpawnScript.velocity*51) * Time.deltaTime;
        ...
        for (int i = 1; i < segmentCount; i++)
        {
			...
			float segTime = (segVelocity.sqrMagnitude != 0) ? (segmentScale*SpawnScript.velocity/10) / segVelocity.magnitude : 0;
